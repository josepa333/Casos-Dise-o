...
public enum TipoMensaje {
    SEGUIRVIP(1), CREARVIP(2), LIKEMENSAJE(3), DISLIKEMENSAJE(4), DARSEBAJA(5), 
    POSTEARMENSAJE(6), NOTIFICACIONNIVEL(7), NOTIFICACIONMENSAJE(8), OBTENERMENSAJES(9), OBTENERVIPS(10);
